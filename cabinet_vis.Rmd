...
cabinet_url <- "http://www.parlgov.org/static/data/experimental-cp1252/view_cabinet.csv"
cabinet_raw <- read_csv(cabinet_url, locale = readr::locale(encoding = "latin1"))
election_url <- "http://www.parlgov.org/static/data/experimental-cp1252/view_election.csv"
election_raw <- read_csv(election_url, locale = readr::locale(encoding = "latin1"))
