...
party_url <- "http://www.parlgov.org/static/data/experimental-cp1252/view_party.csv"
party_raw <- read_csv(party_url, locale = readr::locale(encoding = "latin1"))
```
...
party <- party_raw %>% 
  mutate(region = as.factor(countrycode(country_name, "country.name", "region")),
